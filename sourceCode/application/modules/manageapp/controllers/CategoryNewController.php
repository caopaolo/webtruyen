...
class Manageapp_CategoryNewController extends Amobi_Controller_Action
{
    ...
    public function indexAction()
    {
        try {
            ...
            // Lay du lieu tu DB
            $data = $categoryNewModel->getListCategory();
        ...
        try {
            ...
            if ($this->getRequest()->getMethod() == 'POST') {
                if (! empty($params['name'])) {
                    ...
                    if ($categoryNewModel->checkName($params['name'])) {
    ...
    public function editAction()
    {
        try {
            ...
            if (! empty($params['category_id'])) {
                $category = $categoryNewModel->getDetailCategory($params['category_id']);
                if (! empty($category)) {
                    // Xu ly khi submit form
                    if ($this->getRequest()->getMethod() == 'POST') {
                        if (! empty($params['name'])) {
                            // Kiem tra trung lap ten category
                            if ($categoryNewModel->checkName($params['name'], $params['category_id'])) {
                                ...
                                // Lay lai thong tin
                                $category = $categoryNewModel->getDetailCategory($params['category_id'], $this->_app['app_id']);
                                $data = $category;
        ...
        try {
            ...
            if ($this->_request->isPost()) {
                if (! empty($params['id'])) {
                    ...
                    $category = $categoryNewModel->getDetailCategory($params['id']);
                    if (! empty($category)) {
                        $where = "id = " . $params['id'];
                        $categoryNewModel->delete($where);
