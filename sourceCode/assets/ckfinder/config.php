...
$config['authentication'] = function () {
    session_start();
    if (!empty($_SESSION['Zend_Auth_ManageApp'])) {
        return true;   
    } else {
        return false;
    }
...
$config['licenseKey']  = '0F7F0V00200D03000600V060T00H';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/assets/upload/ckfinder/userfiles/',
...
$config['backends'][] = array(
     'name'         => 'resources_ftp',
     'adapter'      => 'ftp',
     'host'         => '125.212.233.112',
     'username'     => 'ftpcontent',
     'password'     => 'XGbSfK3#Id9!',
     'baseUrl'      => 'http://resources.biz-media.info/resources/'
);
...
$config['resourceTypes'][] = array(
    'name'              => 'Files',
    'directory'         => 'image/content/content/imgcontent',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
    'deniedExtensions'  => '',
    'backend'           => 'resources_ftp'
);
