...
$(function () {
    'use strict';
    var content_id = $('#id').val() || 0 ; // Bien global cho script up file
    
    if (content_id != 0) {
        var url_get = '/manageapp/upload-apk-file?content_id=' + content_id;
        var url_delete = '/manageapp/upload-apk-file?content_id=' + content_id + '&file=';
        var data_get = {'content_id': content_id};
    } else {
        var url_get = '/manageapp/upload-apk-file';
        var url_delete = '/manageapp/upload-apk-file?file=';
        var data_get = {};
    }
    ...
    $('#fileupload').fileupload({
        ...
        add: function (e, data) {
            var that = this;
            data_get.file = data.files[0].name;
            $.getJSON('/manageapp/upload-apk-file', data_get, function (result) {
        ...
        fail: function (e, data) {
            ...
            var fu = $(this).data('blueimp-fileupload') || $(this).data('fileupload'),
                ...
                retry = function () {
                    $.getJSON('/manageapp/upload-apk-file', data_get)
