...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        url: '/manageapp/upload-compressed-file?content_id=' + content_id,
        maxNumberOfFiles: 1,
        ...
        add: function (e, data) {
            var that = this;
            $.getJSON('/manageapp/upload-compressed-file', {content_id: content_id, file: data.files[0].name}, function (result) {
        ...
        fail: function (e, data) {
            ...
            var fu = $(this).data('blueimp-fileupload') || $(this).data('fileupload'),
                ...
                retry = function () {
                    $.getJSON('/manageapp/upload-compressed-file', {content_id: content_id, file: data.files[0].name})
            ...
            if ((data.errorThrown === 'abort') && ("files" in data)) {
                ...
                $.ajax({
                    url: '/manageapp/upload-compressed-file?content_id=' + content_id + '&file=' + file_delete,
                    dataType: 'json',
                    type: 'DELETE',
